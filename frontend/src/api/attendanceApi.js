...
// Points to the unified backend on port 8000
...
// Analytics
export const fetchSummary = () => api.get('/attendance/overview').then(r => r.data);
export const fetchGradeBreakdown = () => api.get('/attendance/distribution').then(r => r.data);
export const fetchRateDistribution = () => api.get('/attendance/distribution').then(r => r.data);
...
// Attendance
export const fetchMonthlySummary = () => api.get('/attendance/monthly-trend').then(r => r.data);
